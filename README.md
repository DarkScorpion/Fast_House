My most crazy program! Dynamic (you can choose the length, width, and with material) to build a house using turtles from the [ComputerCraft mod][compcraft] in MineCraft.
